...
?>	
	<header id="header">
		<div id="header_Wrap">		
			<div class="h_T_box"></div>
			<div class="h_Quickmenu">
				<div class="h_gnb cf fl">
					<a href="http://english.moe.go.kr/"><img src="images/h_gnb_eng.png" alt="영문사이트바로가기" width="94" height="30" onmouseover="this.src='images/h_gnb_eng_h.png'" onmouseout="this.src='images/h_gnb_eng.png'"/></a>
					<a href="http://kids.moe.go.kr/"><img src="images/gnb_child.png" alt="어린이사이트바로가기" width="65" height="30" onmouseover="this.src='images/gnb_child_h.png'" onmouseout="this.src='images/gnb_child.png'"/></a>
					<a href="https://www.moe.go.kr/onedu.do"><img src="images/g_nav_ed.png" alt="교육사이트바로가기" width="65" height="30" onmouseover="this.src='images/g_nav_ed_h.png'" onmouseout="this.src='images/g_nav_ed.png'"/></a>
				</div><!-- class="h_gnb" -->
				<div class="h_box fl">
			...
			<div class="h_logo_menu">
				<div class="h_logo fl">
					<h1><a href="../index.php" title="메인로고이미지입니다" class="showBalloon"><img src="images/HomeLogo.png" alt="메인로고이미지"/></a></h1>
				</div><!-- class="h_logo -->
				<div class="h_C_box fl"></div>
			<div class="main_menu cf fl">		
				<div class="oneInner fl">
					<ul class="oneDepth cf fl">
						<li><a href="../sub1/sub01.html" class="showBalloon" title="국민참여민원 페이지">국민참여&middot;민원</a>
							<div class="twoInner">
